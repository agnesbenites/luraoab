...
export default function SegundaFaseDissertativasOAB() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.title}>Banco de Questões OAB</Text>
        <Text style={styles.subtitle}>
          Treine as questões dissertativas com base nas provas reais da área.
        </Text>
        ...
        <View style={styles.summaryCard}>
          ...
          <Text style={styles.summaryText}>• Base oficial derivada das provas anteriores</Text>
        </View>

        {questoes.length === 0 ? (
          <View style={styles.emptyBox}>
            <Text style={styles.emptyText}>
              Nenhuma questão dissertativa encontrada para esta área.
            </Text>
          </View>
        ) : (
          questoes.map((bloco) => (
              ...
              {bloco.questoes.map((questao: any, index: number) => {
                ...
                return (
                  <View key={key} style={styles.questaoCard}>
                    <Text style={styles.questaoNumero}>
                      Questão {questao.numero || index + 1}
                    </Text>
